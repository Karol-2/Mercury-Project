        ...
        <div className=" bg-my-dark text-my-light p-10 min-h-screen">
          <div className="flex flex-col mb-10 " id="page-content">
            <div className=" text-center select-none" id="header-text">
              <p className="font-bold text-7xl md:text-9xl text-my-orange" id="header-name">
                MERCURY
              </p>
              <p className=" text-my-light font-semibold uppercase" id="header-slogan">
                Modern Communication platform For More Modern Times
              </p>
            </div>
            <div className=" text-my-darker flex flex-row justify-evenly mt-20 lg:mt-72" id="buttons-wrapper">
              <div className=" z-50 flex flex-col lg:flex-row" id="buttons-section">
                <Link to="/login">
                  <button className="btn primary m-5 fade-in " id="login-button">
                    Login
                  </button>
                </Link>
                <Link to="/register">
